...
constructor ZPitchShift.create;
begin
  inherited;
  gRover := 0;
  gInit := 0;
...
destructor ZPitchShift.destroy;
begin
  inherited;
end;

procedure ZPitchShift.reset;
begin
  gRover := 0;
  gInit := 0;
end;
...
procedure ZPitchShift.setup(fftsize,os: Longint; sampleRate:Single);
var
  i,j,k : longint;
begin
...
procedure ZPitchShift.PitchShift(pitchShift: Single; numSampsToProcess{, fftFrameSize, osamp}: Longint; {sampleRate: Single;} indata, outdata: PSingle);
var
...
procedure ZPitchShift.smbFFT(fftBuffer: PSingle; {fftFrameSize,} sign: Longint);
...
function ZPitchShift.smbAtan2(x, y: Double): Double;
var
  signx: Double;
begin
