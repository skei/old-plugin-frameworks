...
type
    ...
    PPSingle = ^psingle;
    // PPDouble = ^pdouble; // ths: get rid of 'Hint: Type "PPDouble" redefinition'
...
const
     ...
     effSetProgramName          = 4;   // [ptr] pchar with new program name, limited to kVstMaxProgNameLen. See AudioEffect.setProgramName
     effGetProgramName          = 5;   // [ptr] char buffer for current program name, limited to kVstMaxProgNameLen. See AudioEffect.getProgramName

     effGetParamLabel           = 6;   // [ptr] char buffer for parameter label, limited to kVstMaxParamStrLen. See AudioEffect.getParameterLabel
     effGetParamDisplay         = 7;   // [ptr] char buffer for parameter display, limited to kVstMaxParamStrLen. See AudioEffect.getParameterDisplay
     effGetParamName            = 8;   // [ptr] char buffer for parameter name, limited to kVstMaxParamStrLen. See AudioEffect.getParameterName
