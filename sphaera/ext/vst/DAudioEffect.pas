...
type
    ...
    public
      ...
      procedure SetProgramName(Name: pchar); virtual;                                                     // Stuff the name field of the current program with name. Limited to kVstMaxProgNameLen.
      procedure GetProgramName(Name: pchar); virtual;                                                     // Stuff name with the name of the current program. Limited to kVstMaxProgNameLen.

      procedure GetParameterLabel(Index: VstInt32; aLabel: pchar); virtual;                               // Stuff label with the units in which parameter index is displayed (i.e. "sec", "dB", "type", etc...). Limited to kVstMaxParamStrLen.
      procedure GetParameterDisplay(Index: VstInt32; Text: pchar); virtual;                               // Stuff text with a string representation ("0.5", "-3", "PLATE", etc...) of the value of parameter index. Limited to kVstMaxParamStrLen.
      procedure GetParameterName(Index: VstInt32; Text: pchar); virtual;                                  // Stuff text with the name ("Time", "Gain", "RoomType", etc...) of parameter index. Limited to kVstMaxParamStrLen.
...
procedure AudioEffect.GetParameterName(Index: VstInt32; Text: pchar);
begin
  StrCopy(Text, '');
end;

procedure AudioEffect.GetParameterDisplay(Index: VstInt32; Text: pchar);
begin
  StrCopy(Text, '');
end;

procedure AudioEffect.GetParameterLabel(Index: VstInt32; aLabel: pchar);
begin
  StrCopy(aLabel, '');
end;
