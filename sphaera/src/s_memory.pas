...
procedure SMemcpy(dst,src:Pointer; count:Integer); inline;
function  SMemmove(dst,src:Pointer; n:Cardinal): Pointer; inline;
procedure SMemset(dst:Pointer; value:Integer; count:Integer); inline;
