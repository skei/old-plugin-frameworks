...
procedure myPlugin.init(srate:single);
begin
  r_6     := 1/6;
...
begin
  ...
  appendParameter( SParamFloat.create('Input',       0, -12, 12, 0.1 ) );
  appendParameter( SParamFloat.create('Low Contour', 0,  0,  10, 0.1 ) );
  appendParameter( SParamFloat.create('Process',     0,  0,  10, 0.1 ) );
  appendParameter( SParamFloat.create('CV',          2,  0,  10, 0.1 ) );
  appendParameter( SParamFloat.create('Output',      0, -12, 12, 0.1 ) );
  appendParameter( SParamText.create( 'Noise Floor', 1, 2, txt_noise ) );
