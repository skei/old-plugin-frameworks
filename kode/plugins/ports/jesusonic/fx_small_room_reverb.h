...
private:
  ...
  bool need_recalc = true;
    ...
    uint32 a0_pos, a1_pos, a2_pos, a3_pos, a4_pos;
    uint32 a0r_pos, a1r_pos, a2r_pos, a3r_pos, a4r_pos;
    float tmp, tmpr, t, tr;
    ...
    /*float*/ uint32   a0,    a1,    a2,    a3,    a4;
    /*float*/ uint32   a0r,   a1r,   a2r,   a3r,   a4r;

    uint32  a0_len,  a1_len,  a2_len,  a3_len,  a4_len;
    float   a0_in,   a1_in,   a2_in,   a3_in,   a4_in;
    float   a0_out,  a1_out,  a2_out,  a3_out,  a4_out;

    uint32  a0r_len, a1r_len, a2r_len, a3r_len, a4r_len;
