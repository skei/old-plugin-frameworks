#ifndef kode_rgba_included
#define kode_rgba_included
//----------------------------------------------------------------------
...
uint32_t KODE_BGRA(KODE_Color AColor) {
  return KODE_BGRA(AColor.r*255,AColor.g*255,AColor.b*255,AColor.a*255);
}
...
uint32_t KODE_RGBA(uint8_t r, uint8_t g, uint8_t b, uint8_t a=255) {
  return  ((uint32_t)a<<24)
        + ((uint32_t)b<<16)
        + ((uint32_t)g<<8)
        + r;
...
uint32_t KODE_RGBA(KODE_Color AColor) {
  uint32_t col = KODE_RGBA(AColor.r*255,AColor.g*255,AColor.b*255,AColor.a*255);
  //KTrace("%8x\n",col);
  return col;
}
...
uint32_t KODE_RGBA_AddSaturate(uint32_t c1, uint32_t c2) {
...
uint32_t KODE_RGBA_AddSaturate2(uint32_t c1, uint32_t c2) {
...
uint32_t KODE_RGBA_AddSaturate3(uint32_t color1, uint32_t color2) {
...
uint32_t KODE_RGBA_SubSaturate(uint32_t c1, uint32_t c2) {
  uint32_t a =  c2 & 0xff000000;
...
uint32_t KODE_RGBA_MulSaturate(uint32_t c1, uint32_t c2) {
  uint32_t a =  c2 & 0xff000000;
  //c1 &= 0xffffff;
  //c2 &= 0xffffff;
...
uint32_t KODE_RGBA_AlphaBlend(uint32_t c1, uint32_t c2) {
...
uint32_t KODE_RGBA_AlphaBlend(uint32_t c1, uint32_t c2, uint8_t a) {
  a = 255 - a;
...
uint32_t KODE_RGBA_AlphaBlend2(uint32_t c1, uint32_t c2, uint8_t a) {
...
uint32_t KODE_RGBA_AlphaBlend3(uint32_t c1, uint32_t c2, uint8_t alpha) {
  alpha = 255-alpha;
  uint32_t a =  c1 & 0xff000000;
...
uint32_t KODE_RGBA_AlphaBlend4(uint32_t c1, uint32_t c2, uint8_t alpha) {
  uint8_t a = (c2 & 0xff000000) >> 24;
  alpha = (alpha*a) >> 8;
  //a = 255 - a;
  uint32_t r = (c2 & 0xff0000) >> 16;
...
uint32_t KODE_RGBA_AlphaBlend5(uint32_t c1, uint32_t c2, uint8_t alpha) {
  uint8_t a = (c2 & 0xff000000) >> 24;
  //alpha = (alpha*a) >> 8;
  //a = 255 - a;
  uint32_t r = (c2 & 0xff0000) >> 16;
...
uint32_t KODE_RGBA_AlphaBlend6(uint32_t c1, uint32_t c2, uint32_t a) {
  uint32_t r = (c1 & 0xFF0000) >> 16;
  uint32_t g = (c1 & 0x00FF00) >> 8;
  uint32_t b = c1 & 0x0000FF;
...
uint32_t KODE_RGBA_AlphaBlend7(uint32_t c1, uint32_t c2, uint32_t factor) {
...
uint32_t KODE_RGBA_BilinearAlphaBlend(uint32_t c1, uint32_t c2, uint32_t c3, uint32_t c4, int32_t bX, int32_t bY) {
...
uint32_t KODE_RGBA_BilinearAlphaBlend2(uint32_t c1, uint32_t c2, uint32_t c3, uint32_t c4, int32_t bX, int32_t bY) {
  int h = (bX & 0xff);
	int i = (bY & 0xff);
	bX = bX >> 8;
	bY = bY >> 8;
...
uint32_t KODE_RGBA_ScaleAlpha(uint32_t c) {
...
uint32_t KODE_RGBA_Scale(uint32_t c, uint8_t a) {
...
uint32_t KODE_RGBA_Scale0(uint32_t c, uint8_t a) {
  //uint8_t alpha = (c & 0xff000000) >> 24;
  //a = 255 - a;
  uint32_t r = (c & 0xff0000) >> 16;
  uint32_t g = (c & 0x00ff00) >> 8;
...
uint32_t KODE_RGBA_Scale2(uint32_t c, uint8_t a) {
  uint8_t alpha = (c & 0xff000000) >> 24;
  a = (a*alpha) >> 8;
  //a = 255 - a;
  uint32_t r = (c & 0xff0000) >> 16;
...
/*
  used in (KODE_RGBA_Alpha):
    KODE_Bitmap.blendPixel
    KODE_Bitmap.premultAlpha
*/

uint8_t KODE_RGBA_ScaleElement(uint32_t c, uint32_t a) {
  uint32_t ret = (c*a) >> 8;
  return ret & 0xff;
}
...
/*
  used in  (KODE_RGBA_Scale):
    KODE_Bitmap.colorMatrix
*/

uint8_t KODE_RGBA_ScaleF(uint8_t c, float n ) {
  float nc = n * (float)c;
...
uint32_t KODE_RGBA_ScaleF2(uint32_t c, float a) {
  uint8_t alpha = (c & 0xff000000) >> 24;
  //a = 255 - a;
  uint32_t r = (c & 0xff0000) >> 16;
  uint32_t g = (c & 0x00ff00) >> 8;
...
uint32_t KODE_RGBA_Grey(uint32_t c) {
...
uint32_t KODE_RGBA_RgbToHsl(uint32_t color) {
...
uint32_t KODE_RGBA_HslToRgb(uint32_t color) {
...
uint32_t KODE_RGBA_RgbToHsv(uint32_t color) {
...
uint32_t KODE_RGBA_HsvToRgb(uint32_t color) {
  uint32_t a_ = (color & 0xff000000) >> 24;
...
//function KODE_RGBA_HsvTween(h0,s0,v0,h1,s1,v1,t)
...
uint32_t KODE_RGBA_Add4(uint32_t c1, uint32_t c2, uint32_t c3, uint32_t c4) {
...
uint32_t KODE_RGBA_Average(uint32_t c1, uint32_t c2) {
  //uint32_t a =  c1 & 0xff000000;
...
uint32_t KODE_RGBA_Average2(uint32_t c1, uint32_t c2) {
