...
: public KODE_Widget {
  ...
  public:
    ...
    : KODE_Widget(ARect) {
      ...
      wdg_label = (KODE_TextWidget*)appendWidget( KODE_New KODE_TextWidget( KODE_Rect(X,Y,      W, 16), "text" ));
      wdg_knob  = (KODE_KnobWidget*)appendWidget( KODE_New KODE_KnobWidget( KODE_Rect(X,Y+16,   W, KS), AValue ));
      wdg_value = (KODE_TextWidget*)appendWidget( KODE_New KODE_TextWidget( KODE_Rect(X,Y+16+KS,W, 16), value_text ));
