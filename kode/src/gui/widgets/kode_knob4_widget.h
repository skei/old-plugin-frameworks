...
: public KODE_Widget {
  ...
  public:
    ...
    : KODE_Widget(ARect) {
      ...
      wdg_label = KODE_New KODE_TextWidget( KODE_Rect( 0,   0, tw, s ), "text" );
      wdg_knob  = KODE_New KODE_KnobWidget( KODE_Rect( tw,  0, s,  s ), AValue );
      wdg_value = KODE_New KODE_TextWidget( KODE_Rect( tw+s,0, tw, s ), value_text );
