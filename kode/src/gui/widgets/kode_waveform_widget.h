...
: public KODE_Widget {
  ...
  public:
    ...
    virtual ~KODE_WaveformWidget() {
      if (MMarkers) KODE_Free(MMarkers);
      if (MAreas) KODE_Free(MAreas);
    }
  ...
  public:
    ...
    void setNumMarkers(int32_t ANum) {
      ...
      if (MMarkers) KODE_Free(MMarkers);
      MMarkers = (KODE_WaveformMarker*)KODE_Malloc(ANum * sizeof(KODE_WaveformMarker));
    }
    ...
    void setNumAreas(int32_t ANum) {
      ...
      if (MAreas) KODE_Free(MAreas);
      MAreas = (KODE_WaveformArea*)KODE_Malloc(ANum * sizeof(KODE_WaveformArea));
    }
