...
: public KODE_Widget {
  ...
  public:
    ...
    : KODE_Widget(ARect) {
      ...
      wdg_knob  = KODE_New KODE_KnobWidget( KODE_Rect( 0, 0,   s, s    ), AValue );
      wdg_label = KODE_New KODE_TextWidget( KODE_Rect( s, 0,   B + ss, s05 ), "text" );
      wdg_value = KODE_New KODE_TextWidget( KODE_Rect( s, s05, B + ss, s05 ), value_text );
