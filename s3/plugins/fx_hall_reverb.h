...
#ifndef fx_hall_reverb_included
#define fx_hall_reverb_included
//----------------------------------------------------------------------
...
: public S3_Plugin {
  ...
  private:
    ...
    bool needrecalc;
    //
    uint32 l0, l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12;
    uint32 Rl0,Rl1,Rl2,Rl3,Rl4,Rl5,Rl6,Rl7,Rl8,Rl9,Rl10,Rl11,Rl12;
    uint32 b0, b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12;
    uint32 Rb0,Rb1,Rb2,Rb3,Rb4,Rb5,Rb6,Rb7,Rb8,Rb9,Rb10,Rb11,Rb12;
    ...
    uint32 p0,  p1,  p2,  p3,  p4,  p5,  p6,  p7,  p8,  p9,  p10,  p11,  p12;
    float  t1,t2;
    //
    ...
    uint32 Rp0,  Rp1,  Rp2,  Rp3,  Rp4,  Rp5,  Rp6,  Rp7,  Rp8,  Rp9,  Rp10,  Rp11,  Rp12;
    float  Rt1,Rt2;
  ...
  public:
    ...
    void on_create(void) final {
      MName       = "fx_hall_reverb";
      MAuthor     = "michael gruhn";
      MDescription    = MName;
      MUniqueId   = S3_MAGIC + s3_fx_hall_reverb_id;
      MNumInputs  = 2;
      MNumOutputs = 2;
      //
      appendParameter( new S3_ParamFloat("dry",      0,  -48,    0  ) );
      appendParameter( new S3_ParamFloat("wet",     -12, -48,    0  ) );
      appendParameter( new S3_ParamFloat("length",   1,    0.01, 3  ) );
      appendParameter( new S3_ParamFloat("predelay", 10,   0,    100) );
      tmp1 = 0;
      tmp2 = 0;
      S3_Memset(&BUF,0,sizeof(BUF));
      needrecalc = true;;
    }
  ...
  public:
    ...
    void on_processBlock(S3_Sample** AInputs, S3_Sample** AOutputs, uint32 ANumSamples) final {
      if (needrecalc) {
        l0   = floorf( slider4/1000*MSampleRate+1 );
        l1   = 3;
        l2   = 13;
        l3   = 31;
        l4   = 103;
        ...
        l11  = 1213;
        l12  = 1553;
        Rl0  = floorf( slider4/1000*MSampleRate+1 );
        Rl1  = 3;
        Rl2  = 11;
        Rl3  = 37;
        Rl4  = 113;
        ...
        g9  = 0.62;
        g11 = 0.62;
        f   = expf( logf(0.001) / ( slider3*MSampleRate / (l5+l6+l7+l8) ) );
        d   = expf( -2*S3_PI*18000/MSampleRate );
