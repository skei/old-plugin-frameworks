...
/*
  ...
  maybe we should use S3_Global in some way?
  this is called both when enumerating, and initializing the plugin
*/
...
/*
  the (bool) return value from the function is to 'force' this to be
  called during global variable initialization (before any function
  calls like 'main')..
*/
