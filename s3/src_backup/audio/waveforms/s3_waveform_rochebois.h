#ifndef s2_waveform_rochebois_included
#define s2_waveform_rochebois_included
//----------------------------------------------------------------------
...
class S2_Waveform_Saw_Rochebois {
  private:
  ...
  public:
    ...
    float process(float t, float dt) {
      ...
      dpw0  = dt;
      ax0   = (aw1-aw0) / dpw0;         // ax0 is calculated on the short integration segment dpw0 = dphase.
      dpx0  = 0.5f * (dpw0+dpw1);
      ay0   = (ax1-ax0) / dpx0;         // ay0 is calculated on the short integration segment dpx0.
      dpy0  = 0.5f * (dpx0+dpx1);
      az0   = (ay1-ay0) / dpy0;         // az0 is calculated on the short integration segment dpy0.
      dpz0  = 0.5f * (dpy0+dpy1);
