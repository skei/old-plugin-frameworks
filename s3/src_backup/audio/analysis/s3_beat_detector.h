#ifndef s2_beat_detector_included
#define s2_beat_detector_included
//----------------------------------------------------------------------

#define FREQ_LP_BEAT  150.0                             /* Low Pass filter frequency */
#define T_FILTER      1.0/(2.0 * S2_PI*FREQ_LP_BEAT)  /* Low Pass filter time constant */
