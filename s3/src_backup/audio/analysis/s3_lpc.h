#ifndef s2_lpc_included
#define s2_lpc_included
//----------------------------------------------------------------------
...
void S2_AutoCorrelate(float* x, float* R, int32 P, float lambda, int32 l=-1) {
//var
//  dl,Rt     : TDoubleArray;
//  r1,r2,r1t : Double;
//  k,i       : Integer;
...
void S2_LevinsonRecursion(P:Integer; R,A,K:TSingleArray) {
var
  Am1       : TDoubleArray;
  i,j,s,m   : Integer;
  km,Em1,Em : Double;
