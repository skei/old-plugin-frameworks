#ifndef s2_audio_io_jack_included
#define s2_audio_io_jack_included
//----------------------------------------------------------------------

#include "audio/io/s2_audio_io.h"

//----------------------------------------------------------------------

class S2_AudioIO_Jack
: public S2_AudioIO {
};
...
int main() {
  ...
  jack_client_t* client = jack_client_open("JackClientTutorial", JackNullOption, 0, 0 );
