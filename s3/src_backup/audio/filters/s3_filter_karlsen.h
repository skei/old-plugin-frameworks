#ifndef s2_filter_karlsen_included
#define s2_filter_karlsen_included
//----------------------------------------------------------------------
...
class S2_Filter_Karlsen {
  ...
  public:
    ...
    uint8 getOverSample(void) { return fOS; }
  ...
  public:
    ...
    void process(float AValue/*, float* L, float* B, float* N, float* H*/) {
      for (int32 o=0; o<fOS; o++) {
        ...
        fPole[1] = (((AValue + /*sDenorm*/ S2_FLOAT_DENORM )-intfp) * fF1) + (fPole[1] * (1 - fF1));
