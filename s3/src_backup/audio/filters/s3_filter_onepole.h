#ifndef s2_filter_onepole_included
#define s2_filter_onepole_included
//----------------------------------------------------------------------
...
class S2_Filter_OnePole {
  ...
  public:
    ...
    */
    ...
    void setup(uint32 AType=0, float ASRate=44100, float AFreq=11000, float AGain=1, bool AInterp=false) {
      //gain
    ...
    */
    ...
    void interpolate(uint32 AFrames) {
    ...
    float process(float AInput) {
      ...
      switch (FType) {
        case 0: // no filter
          ...
          break;
        case 1: // lp
          y = (i_a0 * AInput) + (i_b1*y) + S2_FLOAT_DENORM;
          return (y - S2_FLOAT_DENORM) * _gain;
          break;
        case 2: // hp
          y = (i_a0 * AInput) + (i_b1*y) + S2_FLOAT_DENORM;
          return (AInput - y - S2_FLOAT_DENORM) * _gain;
          break;
        case 3: // ls
          y = (i_a0*AInput) + (i_b1*y) + S2_FLOAT_DENORM;
          return AInput + ((y - S2_FLOAT_DENORM) * _gain2);
          break;
        case 4: // hs
          y = (i_a0*AInput) + (i_b1*y) + S2_FLOAT_DENORM;
          return AInput + ((AInput - y - S2_FLOAT_DENORM) * _gain2);
          break;
      }
    }
