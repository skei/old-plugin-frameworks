#ifndef s2_filter_hiir_included
#define s2_filter_hiir_included
//----------------------------------------------------------------------
...
#include "audio/filters/s2_filter_allpass.h"

//----------------------------------------------------------------------

//rejection=104dB, transition band=0.01

class S2_Filter_Hiir12_Steep {
  private:
    float FPrevious;
    S2_Filter_Allpass a0,a1,a2,a3,a4,a5;
    S2_Filter_Allpass b0,b1,b2,b3,b4,b5;
  public:
    S2_Filter_Hiir12_Steep() {
      FPrevious = 0;
...
class S2_Filter_Hiir10_Steep {
  private:
    float FPrevious;
    S2_Filter_Allpass a0,a1,a2,a3,a4;
    S2_Filter_Allpass b0,b1,b2,b3,b4;
  public:
    S2_Filter_Hiir10_Steep() {
      FPrevious = 0;
...
class S2_Filter_Hiir8_Steep {
  private:
    float FPrevious;
    S2_Filter_Allpass a0,a1,a2,a3;
    S2_Filter_Allpass b0,b1,b2,b3;
  public:
    S2_Filter_Hiir8_Steep() {
      FPrevious = 0;
...
class S2_Filter_Hiir6_Steep {
  private:
    float FPrevious;
    S2_Filter_Allpass a0,a1,a2;
    S2_Filter_Allpass b0,b1,b2;
  public:
    S2_Filter_Hiir6_Steep() {
      FPrevious = 0;
...
class S2_Filter_Hiir4_Steep {
  private:
    float FPrevious;
    S2_Filter_Allpass a0,a1;
    S2_Filter_Allpass b0,b1;
  public:
    S2_Filter_Hiir4_Steep() {
      FPrevious = 0;
...
class S2_Filter_Hiir2_Steep {
  private:
    float FPrevious;
    S2_Filter_Allpass a0;
    S2_Filter_Allpass b0;
  public:
    S2_Filter_Hiir2_Steep() {
      FPrevious = 0;
