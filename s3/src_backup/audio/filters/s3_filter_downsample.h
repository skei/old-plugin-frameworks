#ifndef s2_filter_downsample_included
#define s2_filter_downsample_included
//----------------------------------------------------------------------
...
const float S2_DownSample_Coefficients[32] = {
