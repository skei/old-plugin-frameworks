#ifndef s3_math_fast_included
#define s3_math_fast_included
//----------------------------------------------------------------------
...
float S3_AcosF(const float x);
float S3_AsinF(const float x);
float S3_AtanF(const float x);
float S3_CosF(const float x);
float S3_CosF2(const float x);
float S3_CoshF(const float x);
float S3_CoshF2(const float x);
float S3_ExpF(const float v);
float S3_InverseF(float x);
float S3_InvSqrtF(const float x);
float S3_Log2F(const float val);
float S3_Log10F(const float x);
float S3_LogF(const float &val);
float S3_PowF(float x, unsigned long n);
float S3_SinF(float x);
float S3_SinF2(float x);
float S3_SinhF(const float x);
float S3_SqrtF(const float x);
float S3_TanF(const float x);
float S3_TanhF(const float x);
...
//static __S3_UNUSED
float S3_AsinF(const float x) {
  return S3_PI05 - S3_SqrtF(1 - x)*(1.5707288 - x*(0.2121144 + x*(0.0742610 -
  x*(0.0187293 + 0.395*x))));
}
...
float S3_SinF4(float x) {
  return S3_CosF4(x-S3_PI05);
}
...
double S3_PowF2(double a, double b) {
  union {
    double d;
    int x[2];
  } u = { a };
...
#define S3_MATH_EXTRA_PRECISION

float S3_SinF2(float x) {
  const float B = 4/S3_PI;
  const float C = -4/(S3_PI*S3_PI);
  float y = B * x + C * x * abs(x);
  #ifdef S3_MATH_EXTRA_PRECISION
  //  const float Q = 0.775;
  const float P = 0.225;
