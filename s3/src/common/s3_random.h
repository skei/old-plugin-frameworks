#ifndef s3_random_included
#define s3_random_included
//----------------------------------------------------------------------
...
float   S3_Random(void);
float   S3_RandomSigned(void);
float   S3_RandomRange(float minval, float maxval);
uint32  S3_RandomInt(void);
int32   S3_RandomSignedInt(void);
int32   S3_RandomRangeInt(int32 minval, int32 maxval);
...
//static S3_Random_Rand KODE_RANDOM;
//inline float S3_Random(void) { return S3_RANDOM.random(); }
//inline float S3_RandomSigned(void) { return S3_RANDOM.randomSigned(); }
...
//static _S3_UNUSED
float S3_Random(void) {
  return (float)rand() * S3_INVRANDMAX;// / (float)RAND_MAX;
}
...
//static _S3_UNUSED
float S3_RandomSigned(void) {
  float r = (float)rand() * S3_INVRANDMAX;// / (float)RAND_MAX;
  return r * 2 - 1;
}
...
//static _S3_UNUSED
float S3_RandomRange(float minval, float maxval) {
  return minval + (S3_Random() * (maxval - minval) );
}
...
int32 S3_RandomRangeInt(int32 minval, int32 maxval) {
  ...
  //else return minval + SModulo(S3_RandomInt(),range);
  else return minval + ( S3_RandomInt() % range );
}
