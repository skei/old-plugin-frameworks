  ...
  public:
    ...
    void on_widget_mouseDown(int32 AXpos, int32 AYpos, int32 AButton, int32 AState) override {
      if (AButton==s3_mb_left) {
        if (AState & s3_mk_shift) {
          ...
          MPrevY = AYpos;
          MDragging = true;
          do_widget_cursor(this,s3_mc_hide);
    ...
    void on_widget_mouseUp(int32 AXpos, int32 AYpos, int32 AButton, int32 AState) override {
      if (AButton==s3_mb_left) {
        if (MDragging) {
          MDragging = false;
          do_widget_cursorPos(this,MStartX,MStartY);
          do_widget_cursor(this,s3_mc_show);
          do_widget_redraw(this,MRect,s3_pm_normal);
        }
      }
    }
    ...
    void on_widget_mouseMove(int32 AXpos, int32 AYpos, int32 AState) override {
      int32 prevx = MPrevX;
      int32 prevy = MPrevY;
      MPrevX = AXpos;
      MPrevY = AYpos;
